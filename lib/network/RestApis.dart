...
Future<LoginResponse> signUpApi(Map request) async {
  ...
  return await handleResponse(response).then((json) async {
    ...
    await sharedPref.setString(
        USER_TYPE, loginResponse.data!.user_type.validate());
    await sharedPref.setString(
        FIRST_NAME, loginResponse.data!.first_name.validate());
    await sharedPref.setString(
        LAST_NAME, loginResponse.data!.last_name.validate());
    await sharedPref.setString(
        CONTACT_NUMBER, loginResponse.data!.contact_number.validate());
    await sharedPref.setString(
    ...
    await sharedPref.setString(
        USER_PROFILE_PHOTO, loginResponse.data!.profile_image.validate());
    ...
    await sharedPref.setString(
        LOGIN_TYPE, loginResponse.data!.login_type.validate());
    await sharedPref.setInt(
        IS_Verified_Driver, loginResponse.data!.is_verified_driver ?? 0);
