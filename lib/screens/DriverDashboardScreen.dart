...
class DriverDashboardScreenState extends State<DriverDashboardScreen> {
  ...
  void init() async {
    driverIcon = await BitmapDescriptor.fromAssetImage(
        ImageConfiguration(devicePixelRatio: 2.5), 'images/ic_car.png');
    mqttForUser();
    setTimeData();
    ...
    await getAppSetting().then((value) {
      ...
      appStore.setExtraCharges(value.rideSetting!
              .firstWhere((element) => element.key == APPLY_ADDITIONAL_FEE)
              .value ??
          '0');
    ...
    sourceIcon = await BitmapDescriptor.fromAssetImage(
        ImageConfiguration(devicePixelRatio: 2.5), 'images/ic_source.png');
  ...
  mqttForUser() async {
    ...
    try {
      await client.connect('apnitaxi', 'inam36303');
