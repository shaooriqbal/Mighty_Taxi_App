...
const mAppName = 'ApniTaxi Driver';
var errorThisFieldRequired = 'This field is required';

const googleMapAPIKey = 'AIzaSyBkj2CjrxgexHQOLCjTgQU9-Lb1dM_RgV0';

const DOMAIN_URL =
    'https://muddasir.zeezsoft.com'; // Don't add slash at the end of the url
const mBaseUrl = "$DOMAIN_URL/api/";

final client =
    MqttServerClient.withPort("w0bcd11d.us-east-1.emqx.cloud", "", 15271);

const mOneSignalAppId = '61812bdb-9579-4553-a5f0-89d5753cedb6';
const mOneSignalRestKey = 'NWNjZWI4NjQtMjQyMC00ZWJkLWI0MzMtNzE1MzMzMjcyNmMw';
const mOneSignalChannelID = '850b8144-cfcb-4537-95a4-cb276b930a43';
